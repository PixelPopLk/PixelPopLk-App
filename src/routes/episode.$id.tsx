    ...
    <Shell>
      {isLoading ? (
        ...
        <>
          ...
          {/* 💡 මෙතනට 'dark bg-background text-foreground' එකතු කළා, එවිට එපිසෝඩ් කාඩ් කොටසද සදාකාලිකව ඩාර්ක් මෝඩ් එකෙන්ම පවතී. */}
          <div className="relative overflow-hidden rounded-3xl border border-border shadow-card dark bg-background text-foreground">
            {poster && (
            ...
            <div className="relative grid md:grid-cols-[320px_1fr] gap-0">
              ...
              <div className="p-6 sm:p-8 md:pl-8">
                ...
                {/* 💡 මෙතන තියෙන බටන් දෙක වටේටත් 'ad-trigger' කියන class එක සහිත wrappers දැම්මා */}
                <div className="mt-7 flex flex-col sm:flex-row gap-3">
                  <div className="ad-trigger w-full sm:w-auto">
