...
function Hero({
  ...
  return (
    // 💡 මෙතනට 'dark bg-background text-foreground' එකතු කළා, එවිට මුළු හීරෝ කොටසම සදාකාලිකව ඩාර්ක් මෝඩ් එකෙන්ම පවතී.
...
function MovieView({ item }: { item: Extract<GridItem, { kind: "movie" }> }) {
  ...
  return (
    ...
    >
      ...
      {/* 💡 මෙතන තියෙන බටන් දෙක වටේට 'ad-trigger' කියන class එක සහිත wrappers දැම්මා */}
